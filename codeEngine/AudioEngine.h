...
// The talk outlines a flexible audio engine based on a state machine which is basically used by most AAA games
// The implementation of the engine here does not use the said state machine but makes use of many of the other concepts used
// in the said engine and expands the engine to implement many more features. Refer Documentation for full list of fetures 
// The environment reverb values were obtained from FMOD reverb preset documentation:
